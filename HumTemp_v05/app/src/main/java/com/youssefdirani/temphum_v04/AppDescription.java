...
public class AppDescription extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        description_textView.setText(Html.fromHtml("السلام عليكم صديقي،" +
                "<br/><br/>" +
                ...
                "<br/><br/>" +
                "أي فكرة تعاونية، تعليق، أو اقتراح سيكون مرحّباً به تماماً صديقي.<br/>" +
                "معاً سوف نسعى لنصل لحالتنا الفُضلى الطبيعية.<br/>"));
